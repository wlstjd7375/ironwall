...
public class GlobalVariable {
    ...
    public static final String CLIENT_ID = "PW2Sl6moAyf5DsakQ8Y2";
    public static final boolean IS_DEBUG_MODE = true;

    public static final int FAIL = 0x10000000;
    public static final int SUCCESS = 0x10000001;

    public static int TYPE_INTERNET = 1;
